...
urlpatterns = [
    ...
    url(r'^customer/create/$', views.customer_create_test, name='customer_create'),
    ...
    url(r'^customer/delete_number/(?P<phone>\d+)$', views.customer_delete, name='customer_delete')
]